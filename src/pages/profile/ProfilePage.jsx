              ...
              <div className="flex gap-4">
                <div className="flex flex-col w-3/4 gap-2">
                  ...
                  <div className="flex gap-2">
                    <div
                      className={`flex cursor-pointer items-center justify-center w-[4.8rem] h-12 rounded-sm ${formaPagamentoEstaSelecionada('CARTAO_CREDITO') ? 'ring-2 ring-orange-100' : 'ring-1 ring-gray-300'}`}
                    ...
                    <div
                      className={`flex  cursor-pointer items-center justify-center w-[4.8rem] h-12 rounded-sm ${formaPagamentoEstaSelecionada('CARTAO_DEBITO') ? 'ring-2 ring-orange-100' : 'ring-1 ring-gray-300'}`}
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-center w-[4.8rem] h-12 rounded-sm ${formaPagamentoEstaSelecionada('PIX') ? 'ring-2 ring-orange-100' : 'ring-1 ring-gray-300'}`}
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-center w-[4.8rem] h-12 rounded-sm ${formaPagamentoEstaSelecionada('VALE_ALIMENTACAO') ? 'ring-2 ring-orange-100' : 'ring-1 ring-gray-300'
                        }`}
                    ...
                    <div
                      className={`flex cursor-pointer items-center justify-center w-[4.8rem] h-12 rounded-sm ${formaPagamentoEstaSelecionada('DINHEIRO') ? 'ring-2 ring-orange-100' : 'ring-1 ring-gray-300'}`}
